...
Before beginning, the ggplot library must first be loaded into the project
environment.
...
In this section, we explored how to construct a ggplot, adding aesthetic and
geometric layers, and modifying axis labels / theme.
...
In this section, we made calculations based on a large dataset of genes and
their reactions to an anti-viral drug. We also plotted this information to
further visualize it.
...
Below was the example given for combining multiple plots into one figure.
